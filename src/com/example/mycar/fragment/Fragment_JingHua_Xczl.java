...
public class Fragment_JingHua_Xczl extends Fragment implements OnDownComplete,
	...
	private static Fragment_JingHua_Xczl fn;

	public static Fragment_JingHua_Xczl getFN() {
		if (fn == null) {
			fn = new Fragment_JingHua_Xczl();
		}
		return fn;
	}
	...
	private void loadData() {
		String url = String.format(Constants.URL.BBS_JH_XCZL, page);
