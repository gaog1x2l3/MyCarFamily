...
public class Fragment_JingHua_Hydt extends Fragment implements OnDownComplete,  OnRefreshListener2<ListView> {
	...
	private static Fragment_JingHua_Hydt fn;
	
	public static Fragment_JingHua_Hydt getFN(){
		if(fn==null){
			fn=new Fragment_JingHua_Hydt();
		}
		return fn;
	}
	...
	private void loadData() {
		String url=String.format(Constants.URL.BBS_JH_HYDT, page);
