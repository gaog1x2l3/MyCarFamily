...
public class Fragment_JingHua_Ycbg extends Fragment implements OnDownComplete,  OnRefreshListener2<ListView> {
	...
	private static Fragment_JingHua_Ycbg fn;
	
	public static Fragment_JingHua_Ycbg getFN(){
		if(fn==null){
			fn=new Fragment_JingHua_Ycbg();
		}
		return fn;
	}
	...
	private void loadData() {
		String url=String.format(Constants.URL.BBS_JH_YCBG, page);
