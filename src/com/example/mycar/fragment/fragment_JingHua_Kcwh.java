...
public class fragment_JingHua_Kcwh extends Fragment implements OnDownComplete,  OnRefreshListener2<ListView> {
	private View view;
	private PullToRefreshListView showViews;
	private int page=1;
	private BBS_Jinghua adapter1;
	private List<ZixunEntity> datas;
	private static fragment_JingHua_Kcwh fn;
	
	public static fragment_JingHua_Kcwh getFN(){
		if(fn==null){
			fn=new fragment_JingHua_Kcwh();
		}
		return fn;
	}
	...
	private void loadData() {
		String url=String.format(Constants.URL.BBS_JH_KCWH, page);
