...
public class Fragment_JingHua_Kssj extends Fragment implements OnDownComplete,
	...
	private static Fragment_JingHua_Kssj fn;

	public static Fragment_JingHua_Kssj getFN() {
		if (fn == null) {
			fn = new Fragment_JingHua_Kssj();
		}
		return fn;
	}
	...
	private void loadData() {
		String url = String.format(Constants.URL.BBS_JH_KSSJ, page);
