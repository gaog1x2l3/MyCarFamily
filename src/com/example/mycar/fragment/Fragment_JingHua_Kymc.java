...
public class Fragment_JingHua_Kymc extends Fragment implements OnDownComplete,  OnRefreshListener2<ListView> {
	private View view;
	private PullToRefreshListView showViews;
	private int page=1;
	private BBS_Jinghua adapter1;
	private List<ZixunEntity> datas;
	private static Fragment_JingHua_Kymc fn;
	
	public static Fragment_JingHua_Kymc getFN(){
		if(fn==null){
			fn=new Fragment_JingHua_Kymc();
		}
		return fn;
	}
	...
	private void loadData() {
		String url=String.format(Constants.URL.BBS_JH_KYMC, page);
